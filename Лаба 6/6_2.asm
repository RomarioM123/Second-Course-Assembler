...
.data
    ...
    caption db "Лабораторная работа 6-2. Графические фигуры",0
...
.switch uMsg
    .case WM_COMMAND
        .switch wParam
            ...
            .case 10002
                invoke MsgboxI,hWin,"Рисуем кардиоиду","Рисование кардиоиды",MB_OK,10
                PaintCa
					
            .case 10004
                invoke MsgboxI,hWin,"Перемещаем курсор","Осторожно, разойдитесь",MB_OK,10
                CursorCa
					
            .case 10005
                .data
                    Task db "Нарисовать согласно формулам кардиоиду. Предусмотреть статический и динамический режимы, масштаб отображения, фон экрана и цвет фигуры (фигур с разными параметрами). Координаты вершин в параметрических координатам задаются за формулам:",10,"X = 2Rcost(1+cost);",10,"Y = 2Rsint(1+cost);",10,"где R – радиус окружности.",0
                .code
                    invoke MsgboxI,hWin,ptr$(Task),"Задание",MB_OK,10
					
            .case 10001
                .data
                    msgtxt db "Автор: Момот Роман",10,"Группа: КИТ-119а",0
                .code
