...
.data
    ...
    txt2 db "               КІТ-119а ",0
    txt3 db "Лабораторная работа 8-2-1",0
    txt4 db "Запуск 3 программ, созданных лично,",0
    txt5 db "более 1 раза каждая и программы",0
    txt6 db "калькулятора не больше 3 раз.",0
    txt7 db "из этих программ должны иметь",0
    txt8 db "диалоговые окна.",0
    txt9 db "Одна из лично созданных программ",0
    txt10 db "выполняется 5 секунд, а программа",0
    txt11 db "calc.exe выполняется 10 секунд.",0
...
.switch uMsg
    .case WM_PAINT
        @wmpaind:
            ...
            invoke TextOut,hdc,106,41,addr txt3,25  ; виведення тексту
            invoke TextOut,hdc,72,140,addr txt4,35
            invoke TextOut,hdc,70,160,addr txt5,32
            invoke TextOut,hdc,80,180,addr txt6,29
